 ...
 */
public class ModisAtmosphericCorrectionDialog extends SingleTargetProductDialog {
    ...
    public ModisAtmosphericCorrectionDialog(String operatorName, AppContext appContext, String title, String helpID) {
